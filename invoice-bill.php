...
if ($_GET["order_date"] && $_GET["invoice_no"]){
    ...
    $pdf->Cell(50,10,": Rahua near bela mode muzaffarpur bihar : 842000",0,1);
    ...
    for ($i=0; $i < count($_GET["pid"]) ; $i++) { 
        ...
        $pdf->Cell(22,10, $_GET["hsn"][$i],1,0,"C");
		$pdf->Cell(20,10, $_GET["qty"][$i],1,0,"C");
		$pdf->Cell(30,10, $_GET["price"][$i],1,0,"C");
